...
- Insert
  ...
  ```json
  {
      "data":[{
               ...
               "status":"5",
               "address_id":"72",
               "email":"xuguoyang@boe.com.cn",
               "contact_tel":"+86 18813195067",
               "create_user_name":"徐国炀",
               "create_user_id":"10232538",
               "creator_org":"数据规划与治理科",
...
public class SinkToMySQL extends RichSinkFunction<Meeting>{
    ...
    private static  Connection getConnection(BasicDataSource dataSource) {
        ...
        //替换为自己本地的Mysql数据库地址和用户名，密码
        dataSource.setUrl("jdbc:mysql://master:3306/canal_destination??useUnicode=true&characterEncoding=UTF-8");
...
public class SinkToGreenplum extends RichSinkFunction<Meeting>{
    ...
    private static  Connection getConnection(BasicDataSource dataSource) {
        ...
        //替换为Greenplum数据库地址和用户名，密码
        dataSource.setUrl("jdbc:postgresql://10.252.97.201:5432/datahub?serverTimezone=GMT+8");
        dataSource.setUsername("ur_uapp_data");
        dataSource.setPassword("D@TAtstuapp201");
        //设置连接池的参数
        dataSource.setInitialSize(10);
        dataSource.setMaxTotal(50);
        dataSource.setMinIdle(2);
...
insert.sql（模拟会议室预定，插入10条数据）

```sql
INSERT INTO `canal_test`.`t_meeting_info` (`id`, `meeting_code`, `msite`, `mcontent`, `attend_count`, `type`, `status`, `address_id`, `email`, `contact_tel`, `create_user_name`, `create_user_id`, `creator_org`, `mstart_date`, `mend_date`, `create_time`, `update_user`, `update_time`, `company`, `sign_status`) VALUES ('6', 'M201906210820', '中心组会', '中心组会', '180', '1', '5', '32', 'shiyimo@boe.com.cn', '+86 18510373350', '石一墨', '00004535', '安全保卫科', '2019-07-19 08:00:00', '2019-07-22 18:00:00', '2019-06-21 17:12:22', NULL, NULL, '100', NULL);
INSERT INTO `canal_test`.`t_meeting_info` (`id`, `meeting_code`, `msite`, `mcontent`, `attend_count`, `type`, `status`, `address_id`, `email`, `contact_tel`, `create_user_name`, `create_user_id`, `creator_org`, `mstart_date`, `mend_date`, `create_time`, `update_user`, `update_time`, `company`, `sign_status`) VALUES ('262', 'M201907161007', '新员工培训', '新员工培训', NULL, '1', '5', '32', 'huheqing@boe.com.cn', '+86 18810491101', '胡鹤晴', '112841', 'IAI&BDC HRBP科', '2019-07-29 12:30:00', '2019-07-29 17:30:00', '2019-07-16 17:01:00', NULL, NULL, '100', NULL);
INSERT INTO `canal_test`.`t_meeting_info` (`id`, `meeting_code`, `msite`, `mcontent`, `attend_count`, `type`, `status`, `address_id`, `email`, `contact_tel`, `create_user_name`, `create_user_id`, `creator_org`, `mstart_date`, `mend_date`, `create_time`, `update_user`, `update_time`, `company`, `sign_status`) VALUES ('273', 'M201907170784', 'CFO双周会', 'CFO双周会', '180', '1', '5', '32', 'xiongxiaoxu@boe.com.cn', '+86 13811414851', '熊晓旭', '109082', '保险科', '2019-07-30 08:00:00', '2019-07-30 13:00:00', '2019-07-17 17:00:36', NULL, NULL, '100', NULL);
INSERT INTO `canal_test`.`t_meeting_info` (`id`, `meeting_code`, `msite`, `mcontent`, `attend_count`, `type`, `status`, `address_id`, `email`, `contact_tel`, `create_user_name`, `create_user_id`, `creator_org`, `mstart_date`, `mend_date`, `create_time`, `update_user`, `update_time`, `company`, `sign_status`) VALUES ('294', 'M201907170693', '管培生定岗会-任皓', '管培生定岗会', '180', '1', '5', '32', 'shiyimo@boe.com.cn', '+86 18510373350', '石一墨', '00004535', '安全保卫科', '2019-07-30 13:00:00', '2019-07-30 17:30:00', '2019-07-17 16:16:12', NULL, NULL, '100', NULL);
INSERT INTO `canal_test`.`t_meeting_info` (`id`, `meeting_code`, `msite`, `mcontent`, `attend_count`, `type`, `status`, `address_id`, `email`, `contact_tel`, `create_user_name`, `create_user_id`, `creator_org`, `mstart_date`, `mend_date`, `create_time`, `update_user`, `update_time`, `company`, `sign_status`) VALUES ('304', 'M201906210321', 'BOEU签约仪式-隋一博', 'BOEU签约仪式-隋一博', '180', '1', '5', '32', 'shiyimo@boe.com.cn', '+86 18510373350', '石一墨', '00004535', '安全保卫科', '2019-08-10 08:00:00', '2019-08-11 18:00:00', '2019-06-21 10:54:56', NULL, NULL, '100', NULL);
INSERT INTO `canal_test`.`t_meeting_info` (`id`, `meeting_code`, `msite`, `mcontent`, `attend_count`, `type`, `status`, `address_id`, `email`, `contact_tel`, `create_user_name`, `create_user_id`, `creator_org`, `mstart_date`, `mend_date`, `create_time`, `update_user`, `update_time`, `company`, `sign_status`) VALUES ('309', 'M201903051100', '托业考试', '平行摆放，前后桌间隔50厘米以上', '180', '1', '5', '32', 'shiyimo@boe.com.cn', '+86 18510373350', '石一墨', '00004535', '安全保卫科', '2019-09-07 08:00:00', '2019-09-08 18:00:00', '2019-03-05 16:53:51', 'SYSTEM', '2019-12-04 17:15:00', '100', NULL);
INSERT INTO `canal_test`.`t_meeting_info` (`id`, `meeting_code`, `msite`, `mcontent`, `attend_count`, `type`, `status`, `address_id`, `email`, `contact_tel`, `create_user_name`, `create_user_id`, `creator_org`, `mstart_date`, `mend_date`, `create_time`, `update_user`, `update_time`, `company`, `sign_status`) VALUES ('102', 'M201907020030', '全球经理人会议分会场', '全球经理人分会场', '180', '1', '5', '32', 'shiyimo@boe.com.cn', '+86 18510373350', '石一墨', '00004535', '安全保卫科', '2019-07-23 08:00:00', '2019-07-23 18:00:00', '2019-07-02 08:35:16', NULL, NULL, '100', NULL);
INSERT INTO `canal_test`.`t_meeting_info` (`id`, `meeting_code`, `msite`, `mcontent`, `attend_count`, `type`, `status`, `address_id`, `email`, `contact_tel`, `create_user_name`, `create_user_id`, `creator_org`, `mstart_date`, `mend_date`, `create_time`, `update_user`, `update_time`, `company`, `sign_status`) VALUES ('131', 'M201907110701', '年中工作会', '年中工作会', '180', '1', '5', '32', 'shiyimo@boe.com.cn', '+86 18510373350', '石一墨', '00004535', '安全保卫科', '2019-07-24 08:00:00', '2019-07-24 18:00:00', '2019-07-11 16:13:13', NULL, NULL, '100', NULL);
INSERT INTO `canal_test`.`t_meeting_info` (`id`, `meeting_code`, `msite`, `mcontent`, `attend_count`, `type`, `status`, `address_id`, `email`, `contact_tel`, `create_user_name`, `create_user_id`, `creator_org`, `mstart_date`, `mend_date`, `create_time`, `update_user`, `update_time`, `company`, `sign_status`) VALUES ('388', 'M201908020014', '测试', '测试', '1', '1', '5', '32', 'libaocai@boe.com.cn', '18500158347', '李宝财', '10156600', '业务支援开发科', '2019-08-02 17:30:00', '2019-08-02 18:00:00', '2019-08-02 13:52:23', NULL, NULL, '100', NULL);
INSERT INTO `canal_test`.`t_meeting_info` (`id`, `meeting_code`, `msite`, `mcontent`, `attend_count`, `type`, `status`, `address_id`, `email`, `contact_tel`, `create_user_name`, `create_user_id`, `creator_org`, `mstart_date`, `mend_date`, `create_time`, `update_user`, `update_time`, `company`, `sign_status`) VALUES ('170', 'M201907100473', 'BOE 2019 OpenDay', 'BOE 2019 OpenDay', '180', '1', '5', '32', 'shiyimo@boe.com.cn', '+86 18510373350', '石一墨', '00004535', '安全保卫科', '2019-07-25 08:00:00', '2019-07-25 18:00:00', '2019-07-10 12:44:21', NULL, NULL, '100', NULL);
```

源系统Mysql数据库：

![image-20200731113532181](%E4%BC%9A%E8%AE%AE%E7%AE%A1%E7%90%86%E7%B3%BB%E7%BB%9F%E5%AE%9E%E6%97%B6%E5%88%86%E6%9E%90%E6%80%BB%E7%BB%93.assets/image-20200731113532181.png)

IDEA计算结果：

![image-20200731113751543](%E4%BC%9A%E8%AE%AE%E7%AE%A1%E7%90%86%E7%B3%BB%E7%BB%9F%E5%AE%9E%E6%97%B6%E5%88%86%E6%9E%90%E6%80%BB%E7%BB%93.assets/image-20200731113751543.png)

目标数据库（GreenPlum）：

![image-20200731113851962](%E4%BC%9A%E8%AE%AE%E7%AE%A1%E7%90%86%E7%B3%BB%E7%BB%9F%E5%AE%9E%E6%97%B6%E5%88%86%E6%9E%90%E6%80%BB%E7%BB%93.assets/image-20200731113851962.png)

## 4.可视化方案

- Tableau实时刷新Greenplum，FineBI也可以（秒级）
- DataV也可以每几秒刷新一次
- Flink计算后的结果，写入到缓存，前端开发可视化组件进行展示（实时展示），但是需要前端开发。
